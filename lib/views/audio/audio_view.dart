...
class AudioGenerateView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AudioGenerateController audioGenerateController = Get.put(AudioGenerateController());
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Obx(() {
          ...
          final selectedItem = audioGenerateController.audioGenerate[selectedIndex];
              ...
              children: [
                    ...
                    (index) {
                      return GestureDetector(
                        ...
                        child: AudioGenerateWigets(
                          title: audioGenerateController.audioGenerate[index]['title'],
                          isSelected: audioGenerateController.isSelected == index,
                          imagePath: audioGenerateController.audioGenerate[index]['imagePath'],
                          onClick: () {
                            audioGenerateController.changeSelected(index);
                          },
                        ),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    focusedBorder:
                        OutlineInputBorder(borderRadius: BorderRadius.circular(16), borderSide: BorderSide(color: Theme.of(context).primaryColor, width: 1.5)),
