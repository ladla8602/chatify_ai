...
class Message extends StatelessWidget {
  ...
  final void Function(BuildContext context, LongPressStartDetails? details, types.Message)? onMessageLongPress;
      ...
      case types.MessageType.text:
        ...
        return textMessageBuilder != null
            ...
            : TextMessage(
                ...
                canRegenerate: (message.author.id == "0" && messages.isNotEmpty && messages.first == message) ? true : false,
              );
          ...
          ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  ...
                  onLongPressStart: (LongPressStartDetails details) {
                    if (onMessageLongPress != null) {
                      onMessageLongPress?.call(context, details, message);
                    }
                  },
                ...
                if (user.id != message.author.id && message is types.TextMessage)
                  Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      if (messages.isNotEmpty && messages.first == message)
                        SizedBox(
                          height: 34,
                          width: 34,
                          child: IconButton(
                            onPressed: () => copyToClipboard((message as types.TextMessage).text),
                            iconSize: 18,
                            tooltip: 'Copy',
