...
class SystemMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: TextMessageText(
          bodyLinkTextStyle: InheritedChatTheme.of(context).theme.systemMessageTheme.linkTextStyle,
          bodyTextStyle: InheritedChatTheme.of(context).theme.systemMessageTheme.textStyle,
          boldTextStyle: InheritedChatTheme.of(context).theme.systemMessageTheme.boldTextStyle,
          codeTextStyle: InheritedChatTheme.of(context).theme.systemMessageTheme.codeTextStyle,
          options: options,
          text: message,
        ),
      );
