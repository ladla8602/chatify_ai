...
class Chat extends StatefulWidget {
  ...
  final Function(types.Message?)? onDownloadTap;
  ...
  final void Function()? onRegeneratePressed;

  final void Function(types.PartialText)? onCopyPressed;
  final void Function(types.PartialText)? onSharePressed;

  final void Function(types.PartialText)? onSelectPressed;
    ...
    if (object is DateHeader) {
      ...
      if (message is types.SystemMessage) {
        ...
        final Widget msgWidget = Message(
          ...
          onRegeneratePressed: widget.onRegeneratePressed,
